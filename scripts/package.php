...
foreach(['api.php','index.php','.htaccess','favicon.png'] as $f)copy($root.'/public/'.$f,$out.'/site/'.$f);
...
foreach(['DEPLOYMENT.md','STAFF-GUIDE.md','VERIFICATION.md','BUSINESS-LOCATIONS.md','BUSINESS-IMAGES.md','CAMPAIGN-OFFERS.md','THIRD-PARTY-NOTICES.txt'] as $f){if(!is_file($root.'/docs/'.$f))throw new RuntimeException('Missing release document: '.$f);copy($root.'/docs/'.$f,$out.'/'.$f);}
